...
const userStatus = [{ value: "active", label: "Activo" }];
    ...
    <>
      <form action={formAction}>
        ...
        <div className="mb-5.5 flex w-full flex-wrap">
          ...
          <div className="w-full sm:w-1/2 xl:pl-2.5">
            <label
              className="mb-3 block text-sm font-medium text-black dark:text-white"
              htmlFor="phone"
            >
        ...
        <div className="mb-5.5 flex w-full flex-wrap">
          <div className="w-full pr-2.5 sm:w-1/2">
            ...
            <SelectGroupTwo title="" options={employeeRoles} name="role" />
          </div>
          ...
          <div className="w-full pl-2.5 sm:w-1/2">
            ...
            <SelectGroupTwo title="" options={userStatus} name="status" />
          </div>
        </div>
